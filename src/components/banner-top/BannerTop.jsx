                ...
                <div className='mt-8 md:mt-12'>
                    <div className='grid grid-cols-3 gap-4 mb-4'>
                        <div className='flex justify-start items-center mr-8'>
                            <div className='mr-4'>
                                <img src={icon1} className='w-8 h-8 md:w-12 md:h-12' alt="darul maaqam charlity icon" />
                            </div>
                        ...
                        <div className='col-span-1 md:col-span-2 flex justify-start items-center'>
                            <div className='mr-4'>
                                <img src={icon2} className='w-8 h-8 md:w-12 md:h-12' alt="darul maaqam education icon" />
                            </div>
                            <div className='text-xl text-white'>
                                <p>Education</p>
                            </div>
                    ...
                    <div className='grid grid-cols-3 gap-4 mb-4'>
                        ...
                        <div className='col-span-1 col-span-2 flex justify-start items-center'>
                            <div className='mr-4'>
                                <img src={icon3} className='w-8 h-8 md:w-12 md:h-12' alt="darul maaqam youtube icon" />
                            </div>
                            <div className='text-xl text-white'>
                                <p>Watch Youtube</p>
                            </div>
